...
const TEMA_PAGINA = 'Variables'; // 👈 Tema fijo de esta página

@Component({
  selector: 'app-ejerciciosv',
  templateUrl: './ejerciciosv.page.html',
  styleUrls: ['./ejerciciosv.page.scss'],
  standalone: true,
  imports: [
...
export class EjerciciosvPage {
  selectedLevel: 'basico' | 'intermedio' | 'avanzado' | null = null;

  colabUrls = {
    basico: 'https://colab.research.google.com/drive/12f8zHJEL4NZx2ao7T3wZX1s9LEIOvc7R',
    intermedio: 'https://colab.research.google.com/drive/1EGHGRPmFXZscP1zwlgg-VyuFvifI2hQr',
    avanzado: 'https://colab.research.google.com/drive/1vKOG4jnJa7IMhG1ez_yC3TclU0LUjgqH'
  };
