...
const TEMA_PAGINA = 'For'; // 👈 Tema fijo de esta página

@Component({
  selector: 'app-ejerciciosf',
  templateUrl: './ejerciciosf.page.html',
  styleUrls: ['./ejerciciosf.page.scss'],
  standalone: true,
  imports: [
...
export class EjerciciosfPage {
  selectedLevel: 'basico' | 'intermedio' | 'avanzado' | null = null;

  colabUrls = {
    basico: 'https://colab.research.google.com/drive/14numcdw4PaHK90mdg7XfrtAyzCMUGQwm?usp=drive_link',
    intermedio: 'https://colab.research.google.com/drive/12YywbeN7ZOW8r4WZ_tVE6BHYX_83H1h1?usp=drive_link',
    avanzado: 'https://colab.research.google.com/drive/1NUwrWwi0KfjdQkQ6EF4H7-prt4Reo0dY?usp=drive_link'
  };
