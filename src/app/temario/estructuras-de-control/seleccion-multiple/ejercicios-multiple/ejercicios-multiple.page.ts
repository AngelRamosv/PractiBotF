...
const TEMA_PAGINA = 'Selección múltiple'; // 👈 Tema fijo de esta página

@Component({
  selector: 'app-ejercicios-multiple',
  templateUrl: './ejercicios-multiple.page.html',
  styleUrls: ['./ejercicios-multiple.page.scss'],
  standalone: true,
  imports: [
...
export class EjerciciosMultiplePage {
  selectedLevel: 'basico' | 'intermedio' | 'avanzado' | null = null;

  colabUrls = {
    basico: 'https://colab.research.google.com/drive/1Y41vy-6dBRjPcJ1h-tPMV_ULIhC4dsI0?usp=drive_link',
    intermedio: 'https://colab.research.google.com/drive/1ZEG77d5UygEe97IP8f4zajgP1bC17KQM?usp=drive_link',
    avanzado: 'https://colab.research.google.com/drive/1Kb-jogwpHyw1Z2BjDmc68NLogrs6Z8Vm?usp=drive_link'
  };
