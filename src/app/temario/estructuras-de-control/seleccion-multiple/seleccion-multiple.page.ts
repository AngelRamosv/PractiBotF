...
@Component({
  ...
  templateUrl: './seleccion-multiple.page.html',
  styleUrls: ['./seleccion-multiple.page.scss'],
  standalone: true,
  imports: [
    IonContent,
    IonHeader,
...
export class SeleccionMultiplePage implements OnInit {
  temas = [
  ...
  irEjerciciosMultiple() {
    this.navCtrl.navigateForward('/ejercicios-multiple');
  }
