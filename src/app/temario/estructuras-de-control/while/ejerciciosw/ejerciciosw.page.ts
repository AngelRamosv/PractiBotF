...
const TEMA_PAGINA = 'While'; // 👈 Tema fijo de esta página

@Component({
  selector: 'app-ejerciciosw',
  templateUrl: './ejerciciosw.page.html',
  styleUrls: ['./ejerciciosw.page.scss'],
  standalone: true,
  imports: [
...
export class EjercicioswPage {
  selectedLevel: 'basico' | 'intermedio' | 'avanzado' | null = null;

  colabUrls = {
    basico: 'https://colab.research.google.com/drive/15WhjxxBAOUgWra_oDKg9IPvQdrgiH5jz?usp=drive_link',
    intermedio: 'https://colab.research.google.com/drive/1tGLClFzbmtcfUlpSPDGjaYKSlF6lKuiE?usp=drive_link',
    avanzado: 'https://colab.research.google.com/drive/1AmXo3fxxfUdq6bcGZaTWhA56nYUpa6x8?usp=drive_link'
  };
