...
const TEMA_PAGINA = 'Selección simple'; // 👈 Tema fijo de esta página

@Component({
  selector: 'app-ejercicios-simple',
  templateUrl: './ejercicios-simple.page.html',
  styleUrls: ['./ejercicios-simple.page.scss'],
  standalone: true,
  imports: [
...
export class EjerciciosSimplePage {
  selectedLevel: 'basico' | 'intermedio' | 'avanzado' | null = null;

  colabUrls = {
    basico: 'https://colab.research.google.com/drive/1hu5Wy61oO-_YEzD0LL0aq5bQfm6wcBnM?usp=drive_link',
    intermedio: 'https://colab.research.google.com/drive/1XtSckUursxX0OUbdAKObzeuqiw-iLsCO?usp=drive_link',
    avanzado: 'https://colab.research.google.com/drive/1X4hUQd6Z_Kw7NHib7snvHOcuIYhID8MX?usp=drive_link'
  };
