...
const TEMA_PAGINA = 'Do-while'; // 👈 Tema fijo de esta página

@Component({
  selector: 'app-ejerciciosdw',
  templateUrl: './ejerciciosdw.page.html',
  styleUrls: ['./ejerciciosdw.page.scss'],
  standalone: true,
  imports: [
...
export class EjerciciosdwPage {
  selectedLevel: 'basico' | 'intermedio' | 'avanzado' | null = null;

  colabUrls = {
    basico: 'https://colab.research.google.com/drive/1DIdQCCXcgXiVN15Qjs3aeSRm9CUUNd9B?usp=drive_link',
    intermedio: 'https://colab.research.google.com/drive/1d8_J7TyjR3ElaegUzVTOMmkMYMp6wDRH?usp=drive_link',
    avanzado: 'https://colab.research.google.com/drive/17Fy_0ZMYkhMLFsCWABNlUTkX7cbssuJ7?usp=drive_link'
  };
