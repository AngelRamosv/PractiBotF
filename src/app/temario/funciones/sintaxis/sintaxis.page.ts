...
@Component({
  ...
  templateUrl: './sintaxis.page.html',
  styleUrls: ['./sintaxis.page.scss'],
  standalone: true,
  imports: [
    IonContent,
    IonHeader,
...
export class SintaxisPage implements OnInit {
  temas = [
  ...
  irEjerciciosSintaxis() {
    this.navCtrl.navigateForward('/ejercicios-sintaxis');
  }
