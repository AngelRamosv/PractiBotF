...
const TEMA_PAGINA = 'Sintaxis'; // 👈 Tema fijo de esta página

@Component({
  selector: 'app-ejercicios-sintaxis',
  templateUrl: './ejercicios-sintaxis.page.html',
  styleUrls: ['./ejercicios-sintaxis.page.scss'],
  standalone: true,
  imports: [
...
export class EjerciciosSintaxisPage {
  selectedLevel: 'basico' | 'intermedio' | 'avanzado' | null = null;

  colabUrls = {
    basico: 'https://colab.research.google.com/drive/1Aj9Afo-Br187PkjsNnWJ6-lh4gJuL1OX?usp=drive_link',
    intermedio: 'https://colab.research.google.com/drive/1MLI3Db-6etJWmPPx4TSxdjqfqDtHNUrr?usp=drive_link',
    avanzado: 'https://colab.research.google.com/drive/1xbjljVtK0iMDiO_eRwnxEjePDafeIW1O?usp=drive_link'
  };
