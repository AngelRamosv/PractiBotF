...
const TEMA_PAGINA = 'Tipos de arreglo'; // 👈 Tema fijo de esta página
...
export class EjerciciostPage {
  ...
  colabUrls = {
    basico: 'https://colab.research.google.com/drive/1ADbpkaOfpmialDqcFfK3FEJ8ApvY74jp?usp=drive_link',
    intermedio: 'https://colab.research.google.com/drive/1SQNms9_ze5Gqwqd8ViFRlxdWeouBW0pK?usp=drive_link',
    avanzado: 'https://colab.research.google.com/drive/1B4gHSnDM5R6IsgeC8aYcym7LGcTyS7xi?usp=drive_link'
  };
