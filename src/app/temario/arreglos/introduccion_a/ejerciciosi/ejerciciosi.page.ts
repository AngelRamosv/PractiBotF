...
const TEMA_PAGINA = 'Arreglos Introducción'; // 👈 Tema fijo de esta página

@Component({
  selector: 'app-ejerciciosi',
  templateUrl: './ejerciciosi.page.html',
  styleUrls: ['./ejerciciosi.page.scss'],
  standalone: true,
  imports: [
...
export class EjerciciosiPage {
  selectedLevel: 'basico' | 'intermedio' | 'avanzado' | null = null;

  colabUrls = {
    basico: 'https://colab.research.google.com/drive/1QWBnktdc3LjGfL4JKF1YAnU7RX-0RM6r?usp=drive_link',
    intermedio: 'https://colab.research.google.com/drive/1hImd-z6FcngSpfAcGZ2v0Y_91FLNvFAw?usp=drive_link',
    avanzado: 'https://colab.research.google.com/drive/1hImd-z6FcngSpfAcGZ2v0Y_91FLNvFAw?usp=drive_link'
  };
  ...
  private guardarProgreso() {
    ...
    try {
      ...
      this.showToast('¡Progreso guardado con éxito!', 'primary');
    } catch (error) {
  ...
  private async showToast(message: string, color: 'primary' | 'danger' | 'warning') {
