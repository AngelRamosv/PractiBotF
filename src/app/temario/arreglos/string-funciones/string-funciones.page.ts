...
@Component({
  selector: 'app-string-funciones',
  templateUrl: './string-funciones.page.html',
  styleUrls: ['./string-funciones.page.scss'],
  standalone: true,
  imports: [
    IonContent,
    IonHeader,
...
export class StringFuncionesPage implements OnInit {
  temas = [
  ...
  irEjerciciosSF() {
    this.navCtrl.navigateForward('/ejercicios-sf');
  }
