...
const TEMA_PAGINA = 'String funciones'; // 👈 Tema fijo de esta página

@Component({
  selector: 'app-ejercicios-sf',
  templateUrl: './ejercicios-sf.page.html',
  styleUrls: ['./ejercicios-sf.page.scss'],
  standalone: true,
  imports: [
...
export class EjerciciosSFPage {
  selectedLevel: 'basico' | 'intermedio' | 'avanzado' | null = null;

  colabUrls = {
    basico: 'https://colab.research.google.com/drive/1l82SEEZJMmO5W7VFQ_K2QQwagTX7N_H5?usp=drive_link',
    intermedio: 'https://colab.research.google.com/drive/1tI8iOdbu7twPGIKmPLp8EmgNkXCJO4Fs?usp=drive_link',
    avanzado: 'https://colab.research.google.com/drive/1lsGBPRxhYXBAn9XqXHX1dFctBPhq5rwR?usp=drive_link'
  };
