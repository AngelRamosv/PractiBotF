...
const TEMA_PAGINA = 'Arreglos y funciones'; // 👈 Tema fijo de esta página

@Component({
  selector: 'app-ejerciciosarray',
  templateUrl: './ejerciciosarray.page.html',
  styleUrls: ['./ejerciciosarray.page.scss'],
  standalone: true,
  imports: [
...
export class EjerciciosarrayPage {
  selectedLevel: 'basico' | 'intermedio' | 'avanzado' | null = null;

  colabUrls = {
    basico: 'https://colab.research.google.com/drive/1tWuOy99rfE17KPTQCBIt5O2R4Ax5rTOx?usp=drive_link',
    intermedio: 'https://colab.research.google.com/drive/1SCHNZShXdUk4zM6w6nbLzHv2Fr11SFei?usp=drive_link',
    avanzado: 'https://colab.research.google.com/drive/1tswWNhMiryUBXNRpgBprdeGajzung5v2?usp=drive_link'
  };
