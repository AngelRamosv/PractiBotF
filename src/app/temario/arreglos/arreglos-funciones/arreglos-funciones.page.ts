...
@Component({
  selector: 'app-arreglos-funciones',
  templateUrl: './arreglos-funciones.page.html',
  styleUrls: ['./arreglos-funciones.page.scss'],
  standalone: true,
  imports: [
    IonContent,
    IonHeader,
...
export class ArreglosFuncionesPage implements OnInit {
  temas = [
  ...
  irEjerciciosa() {
    this.navCtrl.navigateForward('/ejerciciosarray');
  }
