...
const TEMA_PAGINA = 'Definición'; // 👈 Tema fijo de esta página

@Component({
  selector: 'app-ejerciciosd',
  templateUrl: './ejerciciosd.page.html',
  styleUrls: ['./ejerciciosd.page.scss'],
  standalone: true,
  imports: [
...
export class EjerciciosdPage {
  selectedLevel: 'basico' | 'intermedio' | 'avanzado' | null = null;

  colabUrls = {
    basico: 'https://colab.research.google.com/drive/1uRyChSPCtmKIA7JWOoM19l7alMPZlC79?usp=drive_link',
    intermedio: 'https://colab.research.google.com/drive/1P-okOtRhe5jgR_YQKHvI6xnpJpkxMpL5?usp=drive_link',
    avanzado: 'https://colab.research.google.com/drive/1UjDJSOVI9kJTBypj6J2HSGZhZSjrb4KR?usp=drive_link'
  };
